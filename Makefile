...
# Generated by qmake (2.01a) (Qt 4.8.4) on: dom 19. may 01:42:54 2013
# Project:  MeteoAstrologia.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -spec ..\..\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=release -o Makefile MeteoAstrologia.pro
#############################################################################
...
Makefile: MeteoAstrologia.pro  ../../Qt/4.8.4/mkspecs/win32-g++/qmake.conf ../../Qt/4.8.4/mkspecs/features/device_config.prf \
		...
		c:/Qt/4.8.4/lib/qaxserver.prl \
		c:/Qt/4.8.4/lib/QAxContainer.prl
	$(QMAKE) -spec ..\..\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=release -o Makefile MeteoAstrologia.pro
