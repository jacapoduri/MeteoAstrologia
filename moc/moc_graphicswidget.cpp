...
**
** Created: Sun 19. May 01:44:23 2013
...
static const char qt_meta_stringdata_graphicsWidget[] = {
    "graphicsWidget\0"
};
...
const QMetaObjectExtraData graphicsWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject graphicsWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_graphicsWidget,
      qt_meta_data_graphicsWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &graphicsWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_graphicsWidget))
